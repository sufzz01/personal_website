  ...
  <div className="max-w-5xl mx-auto">
    ...
    >
      ...
      <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-xl border-slate-200/50 dark:border-slate-700/50">
        <div className="space-y-6 text-slate-700 dark:text-slate-300 text-lg leading-relaxed max-w-prose mx-auto">

          <p className="text-left md:text-justify hyphens-auto break-words">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  {[
                    ...
                    { href: 'https://instagram.com/hey.sufzz', icon: Instagram, label: 'Instagram',value: '@hey.sufzz', color: 'from-pink-500 to-purple-600' }
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-4 mb-8">
              {[
                ...
                { href: 'https://instagram.com/hey.sufzz', icon: Instagram, label: 'Instagram', hover: 'hover:bg-pink-500' },
