            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 mb-4 font-medium">
                  Mahasiswa TI | Graphic Design | Web Developer
                </p>
...
<div className={`hidden md:flex flex-1 ${isEven ? 'justify-end pr-10' : 'pr-10 invisible'}`}>
  {isEven && (
    <div className="w-full max-w-xs bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-2xl p-6 shadow-xl border-slate-200/50 dark:border-slate-700/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
...
<div className="md:hidden flex-1 min-w-0 ml-3 sm:ml-5 overflow-hidden">
  <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-2xl p-4 sm:p-5 shadow-xl border-slate-200/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300 w-full max-w-full">
    <h3 className="font-bold text-base text-slate-900 dark:text-slate-100 mb-1 leading-tight break-words whitespace-normal">
      {edu.institution}
    </h3>
      ...
      {edu.period}
        ...
        <footer className="bg-slate-900 dark:bg-slate-950 text-slate-300 py-12 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-slate-400 mb-6">Mahasiswa TI | Graphic Design | Web Developer</p>
